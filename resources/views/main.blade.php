...
<body class="bg-light">
    <header class="bg-dark text-white py-4 mb-4 shadow">
        <div class="container d-flex justify-content-between align-items-center">
            <h1 class="fw-bold text-white fs-4 m-0">
                Test project
            </h1>
            <div class="d-flex">
                @auth
    ...
    <main>
        <section class="container text-center py-5">
            ...
            <p class="lead text-muted">
                Ця сторінка демонструє, як мій віджет підтримки інтегрується в будь-який інтерфейс.
            </p>
            <div>
                Натисни на синю кнопку в кутку, щоб відкрити форму підтримки.
            </div>
        </section>
    </main>
    <button type="button" class="btn btn-primary position-fixed bottom-0 end-0 m-3 shadow-lg"
        style="width:180px; height:50px;" data-bs-toggle="modal" data-bs-target="#ticketModal">
        Потрібна допомога?
    </button>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content shadow border-0">
                ...
                <div class="modal-body p-0" style="height:640px;">
                    <iframe src="{{ route('tickets.showWidget') }}" width="100%" height="100%" frameborder="0">
                    </iframe>
                </div>
            </div>
        </div>
